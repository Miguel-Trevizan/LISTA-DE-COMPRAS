...
async function carregarLista() {
  ...
  data.forEach((item) => {
    ...
    li.innerHTML = `${item.item} <button onclick="removerItem('${item.id}')" style="border: none; background-color: #fff; cursor: pointer;"><i class="fa-solid fa-circle-xmark"></i></button>`
